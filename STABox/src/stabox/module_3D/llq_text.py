...
def webcache_main(filepath, inh5data_, conf_file_):
    ...
    # inh5ad = sc.read_h5ad(inh5data)
    sc.tl.pca(inh5ad.data, svd_solver='arpack')
    sc.pp.neighbors(inh5ad.data, n_neighbors=20, n_pcs=20)
    sc.tl.leiden(inh5ad.data, resolution=0.3)
    sc.tl.umap(inh5ad.data)
    # sc.pl.umap(inh5ad.data, color=['leiden'])
...
if __name__ == '__main__':
    ...
    # run STARMap
    filepath = 'D:/Users/lqlu/download/3D_SRT_Data/STARMap'
    inh5data = 'cortex_starmap.h5ad'
    conf_file = 'cortex_starmap.atlas.json'
    webcache_main(filepath, inh5data, conf_file)
