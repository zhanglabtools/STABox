...
def tsv_txt_file_to_h5ad(path):
    try:
        ...
        sc.pp.log1p(adata)
        adata.write_h5ad(path + '/new_data.h5ad')

    except:
        print("Make sure your file exist!")


def txt_file_to_h5ad(path):
...
#     # R_HOME = 'D:\\Users\\lqlu\\work\\software\\R-4.2.1'
#     # R_USER = 'D:\\Users\\lqlu\\work\\software\\Anaconda\\envs\\STAKIT\\Lib\\site-packages\\rpy2'
#     # R_env = {"R_HOME": R_HOME,
#     #          "R_USER": R_USER}
#     # path = 'D:\\Users\\lqlu\\work\\code\\STAKIT'
#     # # Renv_setting(R_env, os.path.join(path, "test.yaml"))
#     # load_yaml(os.path.join(path, "test.yaml"))
#     # D:\Users\lqlu\work\Data\STABox_Data\HDST\replicate1_in_GSE130682
#
#     path = 'D:\\Users\\lqlu\\work\\Data\\STABox_Data\\Slide-seqV2\\Mouse-Hippocampus'
#     txt_csv_file_to_h5ad(path)
