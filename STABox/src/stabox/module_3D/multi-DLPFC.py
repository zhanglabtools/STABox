...
import numpy as np
import pandas as pd
from Data_Process.h5ad_wrapper import H5ADWrapper
from Data_Process.obj_wrapper import OBJWrapper
import scanpy as sc
...
if __name__ == '__main__':
    ...
    # run STARMap
    filepath = 'D:/Users/lqlu/download/3D_SRT_Data/Multi-DLPFC'
    inh5data = 'STAligner_Multi_DLPFC.h5ad'
    conf_file = '10X_Multi-DLPFC.atlas.json'
    webcache_main(filepath, inh5data, conf_file)
